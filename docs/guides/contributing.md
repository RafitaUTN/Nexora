...
4. Abre un PR contra `main`; el CI ejecuta los mismos checks + CodeQL + `npm audit`.
...
- El PR debe pasar: CI verde, sin deuda nueva (se audita con el script `npm run audit:code`), sin secretos.
